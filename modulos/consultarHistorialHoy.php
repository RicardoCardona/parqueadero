<?php
	try{
		...
		$sql=$conn->prepare('SELECT vehiculos.placa, flujovehiculo.movFechaInicial, flujovehiculo.movFechaFinal, flujovehiculo.minutosReales, flujovehiculo.valorCalculado, flujovehiculo.valorFlujoVehiculo FROM flujovehiculo INNER JOIN vehiculos ON vehiculos.idVehiculo=flujovehiculo.idVehiculo WHERE flujovehiculo.movFechaInicial LIKE :P1"%" OR flujovehiculo.movFechaFinal LIKE :P1"%"');
